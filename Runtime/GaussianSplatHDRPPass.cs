...
namespace GaussianSplatting.Runtime
{
    ...
    class GaussianSplatHDRPPass : CustomPass
    {
        ...
        protected override void Execute(CustomPassContext ctx)
        {
            ...
            ctx.cmd.SetGlobalTexture(GaussianSplatRenderer.Props.BlitTexture, m_RenderTarget.nameID);
            ctx.cmd.SetGlobalVector(GaussianSplatRenderer.Props.BlitScaleBias, new Vector4(1f, 1f, 0f, 0f));
            ctx.cmd.SetGlobalTexture(GaussianSplatRenderer.Props.CameraTargetTexture, ctx.cameraColorBuffer);
