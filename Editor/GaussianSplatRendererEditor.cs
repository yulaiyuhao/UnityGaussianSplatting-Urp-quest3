...
namespace GaussianSplatting.Editor
{
    ...
    public class GaussianSplatRendererEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (gs.HasValidAsset && gs.splatCount >= 150000 && m_PropSortNthFrame.intValue <= 2)
            {
                EditorGUILayout.HelpBox(
                    $"This asset has {gs.splatCount:N0} splats. Sorting every frame (1–2) costs a full GPU radix sort each frame and often dominates frame time on device. Raise “Sort Every N Frames” to 4–12 (or higher) for a large FPS gain; you may see slightly older draw order between sorts.",
                    MessageType.Info);
            }
